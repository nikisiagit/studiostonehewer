...
- **Hosting Terminology**: NEVER reference or refer to the website or CMS as a "Cloudflare Pages" project. Both the frontend website and the backend CMS are deployed and hosted purely as **Cloudflare Workers**. Always use the correct terminology.
