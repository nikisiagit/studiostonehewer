...
module.exports = async function () {
  ...
  let home = {
    ...
    heroRightLink: '#',
    quoteText:
      "I am unapologetically you. I am a visual, textural, and sensory story of your emotions and the world you want to create. I will provide a space for you to build and grow. Here, you will make memories and share stories. You will laugh, learn, and love. I will be a constant through the ordinary and extraordinary. I am your sanctuary. I am your home.",
    quoteAuthor: "'HOME' BY STUDIO STONEHEWER",
    studioSubtitle: 'THE STUDIO',
    studioTitle: 'Interiors with feeling',
    studioDescription:
      'Studio Stonehewer is an interior design practice devoted to spaces that feel as good as they look. We work slowly and intentionally, layering materials, light, personal curiosa, and considered detail to create homes that hold your story.',
    projectsSubtitle: 'PORTFOLIO',
    projectsTitle: 'Projects',
    projectsDescription:
      'Each project begins with a feeling and ends with a home. From full-service residential interiors to flexible, virtual design studies, browse a selection of our recent work.',
    hwwSubtitle: 'THE STUDIO',
    hwwTitle: 'How we work',
    hwwDescription:
      'Studio Stonehewer is a small, intentional practice. We offer two ways to work together: a flexible virtual service and a full, hands-on service, so each home receives the attention and care it deserves.',
    hwwImage: '/assets/images/living_room_art_1782489455807.png',
    virtualTitle: 'The Digital Studio',
    virtualDescription:
      'Digital Interior Design offers a flexible and virtual approach to one or multiple spaces. Through design mapping, creation and reviews, we create a custom plan with moodboards, 3D elevations and shopping lists that can be implemented on your own time and budget.',
    virtualExpectations: splitText(rawVirtualExpectations),
    fullTitle: 'The Full Service Studio',
    fullDescription:
      'An interior design service for larger scale projects including in-person consultations, project management, site visits, furniture procurement and supporting hands-on installation.',
    fullExpectations: splitText(rawFullExpectations),
    ctaTitle: 'Have a space in mind?',
    ctaDescription:
      "Whichever service feels right, we'd love to hear about your home and how you want it to feel.",
    aboutSubtitle: 'ABOUT',
    aboutTitle: 'Studio Stonehewer',
    aboutImage: '/assets/images/eric-about.png',
    aboutRole: 'FOUNDER',
    ...
    contactDescription:
      "Whether you're ready to begin or simply exploring ideas, we'd love to hear from you. Tell us a little about your home and what you're hoping to create.",
  ...
  let portfolio = {
    ...
    headerDescription:
      'Each project begins with a feeling and ends with a home. Browse our full selection of recent work.',
  };

  const [homeData, portData] = await Promise.all([
    fetchJson(`${API_URL}/home`, 'Payload Home global'),
    fetchJson(`${API_URL}/portfolio`, 'Payload Portfolio global'),
  ]);
  ...
  if (homeData && homeData.quote_text) {
    home = {
      ...
      heroLeftLink: sanitizeHref(homeData.hero_left_link || '#', '#'),
      ...
      heroRightLink: sanitizeHref(homeData.hero_right_link || '#', '#'),
      ...
      virtualExpectations: homeData.virtual_expectations
        ? splitText(homeData.virtual_expectations)
        : home.virtualExpectations,
      fullTitle: homeData.full_title || home.fullTitle,
      fullDescription: homeData.full_description || home.fullDescription,
      fullExpectations: homeData.full_expectations
        ? splitText(homeData.full_expectations)
        : home.fullExpectations,
      ...
      guides:
        homeData.guides && parseGuides(homeData.guides).length > 0
          ? parseGuides(homeData.guides)
          : home.guides,
